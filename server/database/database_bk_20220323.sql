...
MySQL Backup
Database: knowledge
Backup Time: 2022-03-23 19:10:24
*/
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `attend_list_views` AS select `u`.`id` AS `user`,`u`.`nickname` AS `nickname`,`c`.`id` AS `competition`,`c`.`title` AS `competition_title`,`c`.`status` AS `progress`,`a`.`status` AS `status`,`a`.`date` AS `date`,`a`.`form` AS `form`,`a`.`works` AS `works`,`a`.`id` AS `id` from ((`attend` `a` join `users` `u` on((`a`.`user` = `u`.`id`))) join `competitions` `c` on((`a`.`competition` = `c`.`id`)));
BEGIN;
LOCK TABLES `knowledge`.`attend` WRITE;
DELETE FROM `knowledge`.`attend`;
INSERT INTO `knowledge`.`attend` (`id`,`user`,`competition`,`date`,`status`,`form`,`works`,`score`,`comments`) VALUES (55, 3, 2, '2022-03-23 11:29:04', 'pass', '{\"nickname\":\"奇奇怪怪的用户名\",\"name\":\"\",\"phone\":\"\",\"email\":\"\",\"xueli\":\"\",\"school\":\"\",\"address\":\"\"}', '/storage/works/uid_3/参赛作品001.rar', NULL, NULL);
UNLOCK TABLES;
COMMIT;
BEGIN;
LOCK TABLES `knowledge`.`competitions` WRITE;
DELETE FROM `knowledge`.`competitions`;
INSERT INTO `knowledge`.`competitions` (`id`,`type`,`cover`,`title`,`desc`,`organizer`,`start_date`,`end_date`,`register_start_date`,`register_end_date`,`status`,`introduce`,`rules`,`awards`) VALUES (2, 1, '/storage/competition/cover/20220322\\c60a9decebe710ef8d5bb4e0467c551e.jpg', '很长网络安全的比赛很长网络安全的比赛很长网络安全的比赛很长网络安全的比赛', '1111111', '[\"sdf\",\"111\",\"222\",\"33\",\"44\"]', '2022-03-20 16:00:00', '2022-03-30 16:00:00', '2022-03-12 16:00:00', '2022-03-20 16:00:00', 'started', '<h1 id=\"68fsn\">水电费水电费是打发斯蒂芬</h1><p><font color=\"#46acc8\">水电费水电费</font></p><p>水电费</p><p><font color=\"#c24f4a\">士大夫撒</font></p><p>水电费<img src=\"http://localhost:8090/storage/images/20220321\\0f47d36304a5749630e6b128f71ad2f3.jpg\" contenteditable=\"false\" style=\"font-size: 14px; max-width: 100%;\" width=\"30%\"/><img src=\"http://localhost:8090/storage/images/20220321\\5ae1b34f21757e89cdbb055dc454c3ee.jpg\" style=\"max-width:100%;\" contenteditable=\"false\"/></p>', '<h1>水电费水电费是打发斯蒂芬</h1><p>水电费水电费</p><p>水电费</p><p>士大夫撒</p><p>水电费<img src=\"http://localhost:8090/storage/images/20220321\\6df523dc7e68caf0294f8207da8d19e3.jpg\" contenteditable=\"false\" style=\"font-size: 14px; max-width: 100%;\" width=\"30%\"/></p>', '<h1>水电费水电费是打发斯蒂芬</h1><p>水电费水电费</p><p>水电费</p><p>士大夫撒</p><p>水电费</p>'),(4, 3, '/storage/competition/cover/20220322\\32b6db3398e3c867168e5f034f66ee7b.jpg', '士大夫撒', '士大夫撒', '[\"主办方\"]', '2022-03-15 16:00:00', '2022-04-16 16:00:00', '2022-03-11 16:00:00', '2022-04-18 16:00:00', 'started', '<p>士大夫撒</p>', '<p>士大夫撒</p>', '<p>士大夫撒</p>'),(5, 3, '/storage/competition/cover/20220322\\b190f20d0007f29dcef3d57a6f85bf31.jpg', '很长网络安全的比赛很长网络安全的比赛很长网络安全的比赛很长网络安全的比赛很长网络安全的比赛', '很长网络安全的比赛很长网络安全的比赛很长网络安全的比赛很长网络安全的比赛很长网络安全的比赛很长网络安全的比赛很长网络安全的比赛很长网络安全的比赛很长网络安全的比赛很长网络安全的比赛很长网络安全的比赛很长网络安全的比赛很长网络安全的比赛很长网络安全的比赛很长网络安全的比赛很长网络安全的比赛很长网络安全的比赛很长网络安全的比赛很长网络安全的比赛很长网络安全的比赛很长网络安全的比赛', '[\"111\"]', '2022-05-09 16:00:00', '2022-05-25 16:00:00', '2022-03-13 16:00:00', '2022-03-20 16:00:00', 'registerEnd', '<p>很长网络安全的比赛</p>', '<p>很长网络安全的比赛</p>', '<p>很长网络安全的比赛</p>'),(6, 3, '/storage/competition/cover/20220322\\5e980104683924b1ea4081becc94b3ef.jpg', '很长网络安全的比赛很长网络安全的比赛很长网络安全的比赛很长网络安全的比赛很长网络安全的比赛', '很长网络安全的比赛很长网络安全的比赛很长网络安全的比赛很长网络安全的比赛很长网络安全的比赛很长网络安全的比赛很长网络安全的比赛很长网络安全的比赛很长网络安全的比赛很长网络安全的比赛很长网络安全的比赛很长网络安全的比赛很长网络安全的比赛很长网络安全的比赛很长网络安全的比赛很长网络安全的比赛很长网络安全的比赛很长网络安全的比赛很长网络安全的比赛很长网络安全的比赛很长网络安全的比赛', '[\"111\"]', '2022-03-08 16:00:00', '2022-04-26 16:00:00', '2022-03-14 18:00:00', '2022-04-27 18:00:00', 'started', '<p>很长网络安全的比赛</p>', '<p>很长网络安全的比赛</p>', '<p>很长网络安全的比赛</p>');
UNLOCK TABLES;
COMMIT;
BEGIN;
