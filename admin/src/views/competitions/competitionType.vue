  ...
  <div class="app-container">
    ...
    >
      <el-form ref="myForm" :model="form">
        ...
        <el-form-item label="类型描述" :label-width="formLabelWidth" prop="desc">
...
import {
  ...
  deleteCompetitionTypeById
} from '@/api/competitionType'
  ...
  methods: {
    ...
    handleSave() {
      ...
      if (this.isCreate) {
        ...
        delete data.id
        createCompetitionType(data).then(res => {
          console.log(res)
          this.loading = false
        ...
        updateCompetitionType(this.form).then(res => {
          console.log(res)
          this.loading = false
          this.$message.success('保存成功.')
          this.dialogFormVisible = false
    ...
    handleDelete(index, row) {
      deleteCompetitionTypeById(row.id).then(res => {
